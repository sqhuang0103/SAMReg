...
im1 = Image.open("/home/shiqi/SAMReg/example/pathology/1B_B7_R.png")
im2 = Image.open("/home/shiqi/SAMReg/example/pathology/1B_B7_R.png")
print(im1.size)
device='cuda:1'
from transformers import pipeline
...
im1_cv = cv2.imread("/home/shiqi/SAMReg/example/pathology/1B_B7_R.png")
im2_cv = cv2.imread("/home/shiqi/SAMReg/example/pathology/1B_B7_R.png")
