...
class RoiMatching():
    def __init__(self,img1,img2, args, mode = 'embedding', url = "facebook/sam-vit-huge"):
        """
        Initialize
        ...
        self.sim_criteria = args.sim_criteria
        self.jacobian = args.jacobian_inverse
    ...
    def _sam_everything(self,imgs):
        ...
        match self.sam_type:
            ...
            case 'medsam':
                ...
                outputs = generator(imgs, points_per_batch=64,stability_score_thresh=0.5,) #medsam
